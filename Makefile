...
deploy-check:
ifeq ($(IMG),$(LATEST))
	@echo "PLEASE PROVIDE THE ARGUMENT 'IMG' WHEN RUNNING 'make deploy'. EXAMPLE OF USAGE: 'make deploy IMG=ghcr.io/reallyenglish-global/kubegres:v1.20'"
	exit 1
endif
...
## eg: 'make deploy IMG=ghcr.io/reallyenglish-global/kubegres:v1.20'
