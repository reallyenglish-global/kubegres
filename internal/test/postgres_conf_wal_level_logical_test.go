...
var _ = Describe("We set the wal-level to 'logical' and simulate when Primary instance is not available then recovery/failover works", Label("core-failover", "shard-8"), func() {
